  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        ...
        directives: {
          "script-src":
            "'self' 'unsafe-inline' use.typekit.net www.google-analytics.com www.googletagmanager.com gstatic.com *.gstatic.com https://d3ey4dbjkt2f6s.cloudfront.net/ https://assets.pinterest.com/js/pinit.js",
          "style-src":
