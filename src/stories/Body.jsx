...
export const Body = ({ primary, backgroundColor, size, label, ...props }) => {
  ...
  return (
    <>
      ...
      <section className="">{/* light__test */}
          body &#123;<br />
            <span>&nbsp;&nbsp;background: </span><span><HSLBody /></span><br />
            &nbsp;&nbsp;color: hsl(215, 12%, 12%);<br />
            &nbsp;&nbsp;<span className='selection__test'>selection: hsl(35, 100%, 50%);</span><br />
            &nbsp;&nbsp;<a href="#" className="light__link">Link: hsl(35, 100%, 30%);</a><br />
            &nbsp;&nbsp;<span className="hover__test">Link Hover: hsl(35, 100%, 50%); - this has 2.16:1 contrast to the background</span><br />
          &#125;
          </section>
        ...
        {/*  <section className="dark__test">
          @dark body &#123;<br />
            <span>&nbsp;&nbsp;background:</span><span>hsl(35, 100%, 99%);</span><br />
            &nbsp;&nbsp;color: hsl(215, 12%, 12%);<br />
            &nbsp;&nbsp;<span className='selection__test'>selection: hsl(35, 100%, 50%)</span><br />
            &nbsp;&nbsp;<a href="#" className="dark__link">Link: hsl(35, 100%, 30%)</a><br />
            &nbsp;&nbsp;<span className="hover__test">Link Hover: hsl(35, 100%, 50%) - this has 2.16:1 contrast to the background</span><br />
          &#125;
          </section> */}
          </>
