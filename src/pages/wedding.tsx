    ...
    <>
      ...
      <main>
        ...
        <div className="measure" itemProp="hasOfferCatalog" itemScope itemType="https://schema.org/OfferCatalog">
          ...
          <p>Your <Link to="/venues">venue</Link>, <Link to="/vendors">decor</Link>, <Link to="/vendors/floral/">flowers</Link>, cake and <Link to="/vendors/photography">photographer</Link> are all big investments. Make the most of them with the right lighting design and these elements will shine even brighter.</p>

          <p>Sierra Lighting approaches every event from a photographic standpoint. Your pictures last forever and we want to be certain they look their best. We communicate with your <Link to="/vendors/production">event designer</Link>, <Link to="/vendors/planning">planner</Link>, <Link to="/vendors/floral">florist</Link>, <Link to="/vendors/photography">photographer</Link>, and videographer ahead of your wedding. Once we understand the focal points of an event, we can create a lighting scheme that will best accentuate those details. We look at the big picture of an event. When the photographer takes a picture across the room of the couple dancing, they should be lit, along with the centerpieces, the band, and the wall in the back, to highlight all the important focal points of your event.</p>
